...
Это статическая браузерная демка. В ней нет backend, сборщика и runtime-зависимостей. Первый экран является рабочей доской: компактный appbar, левая панель ассистента, центральные канбан-колонки и правая панель деталей.
