...
Это статическая браузерная демка. В ней нет backend, сборщика и runtime-зависимостей. Первый экран является рабочей доской: commandbar, компактный ассистент, строка выбранной карточки и канбан-колонки на всю ширину.
